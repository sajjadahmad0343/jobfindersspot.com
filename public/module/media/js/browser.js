    ...
    window.uploaderModal = new Vue({
        ...
        methods:{
            show(configs){
                ...
                this.modalEl.modal({fadeDuration: 250}).addClass('show');
                this.reloadLists();
            },
            hide(){
                ...
                superioApp.showConfirm({
                    ...
                    callback: function(result){
                        if(result){
                            me.isLoading = true;
                            $.ajax({
                                url:superio.url+'/admin/module/media/removeFiles',
                                type:'POST',
                                data:{
            ...
            removeFiles() {
                let me = this;
                let message = i18n.confirm_delete;
                let showConfirm = confirm(message);
                if (showConfirm){
                    me.isLoading = true;
                    $.ajax({
                        url:superio.url+'/admin/module/media/removeFiles',
            ...
            reloadLists(){
                ...
                me.isLoading = true;
                $.ajax({
                    url:superio.url+'/admin/module/media/getLists',
                    type:'POST',
                    data:{
            ...
            upload(files){
                ...
                for(var i = 0; i < files.length ; i++){
                    ...
                    me.isLoading = true;
                    $.ajax({
                        url:superio.url+'/admin/module/media/store',
                        data:d,
                        dataType:'json',
                        type:'post',
                        contentType: false,
